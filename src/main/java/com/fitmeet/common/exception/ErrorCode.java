...
public enum ErrorCode {
    ...
    AUTHENTICATION_REQUIRED(HttpStatus.UNAUTHORIZED, "AUTH_007", "Authentication is required."),
    INVALID_ACCESS_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH_008", "Access token is invalid."),
